...
export default function PrivacyPage() {
  return (
    <Container className="flex flex-col gap-2 pb-16">
      ...
      <h3 className="pt-2 text-2xl font-bold">Interpretation</h3>
      <p>
      ...
      <h3 className="pt-2 text-2xl font-bold">Definitions</h3>
      ...
      <h3 className="pt-2 text-2xl font-bold">Types of Data Collected</h3>
      <h4 className="pt-2 text-xl font-bold">Personal Data</h4>
      <p>
      ...
      <h4 className="pt-2 text-xl font-bold">Usage Data</h4>
      ...
      <h3 className="pt-2 text-2xl font-bold">Use of Your Personal Data</h3>
      <p>The Company may use Personal Data for the following purposes:</p>c
      <ul className="list-outside list-disc space-y-2 pl-8">
        <li>
          <p>
      ...
      <h3 className="pt-2 text-2xl font-bold">
      ...
      <h3 className="pt-2 text-2xl font-bold">Delete Your Personal Data</h3>
      <p>
      ...
      <h4 className="pt-2 text-xl font-bold">Business Transactions</h4>
      <p>
      ...
      <h4 className="pt-2 text-xl font-bold">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="pt-2 text-xl font-bold">Other legal requirements</h4>
      <p>
