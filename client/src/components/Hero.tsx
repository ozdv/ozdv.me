    ...
    <>
      <section className="relative">
        <Container className="flex flex-col items-center pb-20 sm:mt-10 sm:pb-40">
          ...
          <h1 className="mx-auto mt-10 text-2xl font-semibold text-zinc-900 dark:text-zinc-100 sm:text-5xl">
            ...
            <span className="relative whitespace-nowrap">
              ...
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-3/4 h-[0.7em] w-full fill-zinc-200 dark:fill-zinc-800"
          ...
          <h3 className="mt-4 text-center text-base font-medium text-zinc-500 dark:text-zinc-400 sm:text-2xl">
        ...
        <div className="absolute bottom-[-1px] left-0 w-full rotate-180">
          <svg
          ...
          >
            <path
              ...
              className="shape-fill fill-zinc-100 dark:fill-zinc-800"
            ></path>
          </svg>
        </div>
      </section>
