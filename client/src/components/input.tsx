  ...
  return (
    <span
      ...
      className={clsx(
        ...
        "[&>[data-slot=icon]]:size-5 sm:[&>[data-slot=icon]]:size-4 [&>[data-slot=icon]]:pointer-events-none [&>[data-slot=icon]]:absolute [&>[data-slot=icon]]:top-3 [&>[data-slot=icon]]:z-10 sm:[&>[data-slot=icon]]:top-2.5",
